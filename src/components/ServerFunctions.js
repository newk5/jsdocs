...
export class ServerFunctions extends Component {
                        ...
                        <AccordionTab header="General functions"><br />
                                <ul>
                                    <li>
                                       ...
                                       <PrismHighlight  language="javascript" title="server.sendClientMsg(Player recipient, Colour colour, String message)" >
                                            {
 `function onPlayerConnect(player) {
     ...
     server.sendClientMsg(null, new Colour(102, 162, 232),  player.name +" has joined the server"); 
                                    ...
                                    <li>
                                        <PrismHighlight description="used to send annoucements" language="javascript" title="server.sendGameMessage(Player recipient, integer type, String message);" >
                                            {
       ...
       if (message.startsWith("ann ")){
           ...
           server.sendGameMessage(null, type, msg); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.shutdownServer();" >
                                            {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("shutdown")){
            server.shutdownServer()
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.createExplosion(integer worldId, integer type, Vector position, Player responsiblePlayer, boolean atGroundLevel);" >
                                            {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("boom")){
           server.createExplosion(player.world, 1, player.pos, player, true);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.playSound(integer worldId, integer soundId, Vector pos);" >
                                            {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("playSound")){
           server.playSound(player.world, 2, player.pos);
                            ...
                            <AccordionTab header="Weapon Functions">
                                <ul>
                                    <li>
                                        <PrismHighlight language="javascript" title="server.resetAllWeaponData();" >
                                            {
   `function onPlayerCommand(player, message) {
       if (message.startsWith("resetWepsData")){
            server.resetAllWeaponData();
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.resetWeaponData(integer weaponId)" >
                                            {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("resetWepData ")){
           ...
           server.resetWeaponData(id);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="Weapon fields" >
                                            {
                                                `WeaponField.Unused
...
WeaponField.WeaponSlot`
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setWeaponDataValue(integer weaponId, WeaponField field, float value)" >
                                        {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("setWepValueDmg ")){ /* /setWepValueDmg <wepID> <value> */
           ...
           server.setWeaponDataValue(wepID, WeaponField.Damage, value);         
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getWeaponDataValue(integer weaponId, WeaponField field);" >
                                        {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("getWepValueDmg ")){ /* /getWepValueDmg <wepID>  */
           ...
           server.sendClientMsg(player, new Colour(102, 162, 232),  "Weapon damage: " +value); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.resetWeaponDataValue(integer weaponId, WeaponField field);" >
                                        {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("resetWepDmg ")){ /* /resetWepDmg <wepID>  */
           ...
           server.resetWeaponDataValue(wepID, WeaponField.Damage); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.isWeaponDataValueModified(integer weaponId, WeaponField field);" >
                                        {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("isWepDmgModified ")){ /* /isWepModified <wepID>  */
           ...
           server.sendClientMsg(player, new Colour(102, 162, 232),  (changed ? "Weapon damage has been modified": "Weapon damage has not been modified"));  
                            ...
                            <AccordionTab header="Administrative Functions"><br />
                                <ul>
                                    <li>
                                        <PrismHighlight language="javascript" title="server.kick(player)" >
                                            {
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.banAddress(String ip)" >
                                            {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("banip ")){
           ...
           server.banAddress(ip);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.unbanAddress(String ip)" >
                                            {
                                                `function onPlayerCommand(player, message) {
       if (message.startsWith("unbanip ")){
           ...
           server.unbanAddress(ip);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.isAddressBanned(String ip)" >
                                            {
                                                `function onPlayerCommand(player, message) {
           ...
           server.sendClientMsg(player, new Colour(102, 162, 232), ip +  (banned ? " is banned":"isn't banned") );
                            ...
                            <AccordionTab header="Server settings">
                                <ul>
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getServerVersion()" >
                                            {
    ...
    console.log( "Server version: "+server.getServerVersion() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.addClass(teamId, col, modelId, x, y, z, angle, wep1, ammo1, wep2, ammo2, wep3, ammo3)" >
                                            {
                                                `function onServerInitialise() {  
    var teamId = 6;
    ...
    server.addClass(teamId, col, modelId, x, y, z, angle, wep1, ammo, wep2, ammo, wep3, ammo);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getServerPort();" >
                                            {
                                                `function onServerInitialise() {
    console.log( "Server started on port: "+server.getServerPort() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getServerName()" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server name: "+server.getServerName() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setServerName(String name)" >
                                            {
                                                `function onServerInitialise() {   
    server.setServerName("My server");
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getPlayerLimit();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server player limit: "+server.getPlayerLimit() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setPlayerLimit(integer playerLimit);" >
                                            {
                                                `function onServerInitialise() {   
    server.setPlayerLimit(50); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getServerPassword();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server password: "+server.getServerPassword() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setServerPassword(String password);" >
                                            {
                                                `function onServerInitialise() {   
    server.setServerPassword("serverPassword123"); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setGameModeText();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server gamemode: "+server.getGameModeText() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setGameModeText(String text);" >
                                            {
                                                `function onServerInitialise() {   
    server.setGameModeText("TDM 1.0"); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setWorldBounds(MapBounds bounds);" >
                                            {
                                                `function onServerInitialise() {
    var maxX= 1000;
    var minX = 200;
    ...
    server.setWorldBounds(new MapBounds(maxX, minX, maxY, minY)); 
                                    ...
                                    <li>
                                        <PrismHighlight className="getWorldBounds code-highlight" description="returns MapBounds" language="javascript" title="server.getWorldBounds();" >
                                            {
                                                `function onServerInitialise() {   
    ...
    console.log("MapBounds: X " + bounds.maxX + " | " + bounds.minX + " , Y "+bounds.maxY+" | "+bounds.minY);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setHour(integer hour);" >
                                            {
                                                `function onServerInitialise() {   
    server.setHour(10); 
}`
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getHour();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server hour: "+server.getHour() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setMinute(integer minutes);" >
                                            {
                                                `function onServerInitialise() {   
    server.setMinute(10); 
}`
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getMinute();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server minutes: "+server.getMinute() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setTimeRate(integer timeRate);" >
                                            {
                                                `function onServerInitialise() {   
    server.setTimeRate(2); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getTimeRate();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server timerate: "+server.getTimeRate() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setWeather(integer weather);" >
                                            {
                                                `function onServerInitialise() {   
    server.setWeather(4); 
}`
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getWeather();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server weather: "+server.getWeather() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setGravity(float gravity);" >
                                            {
                                                `function onServerInitialise() {   
    server.setGravity(0.5); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getGravity();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server gravity: "+server.getGravity() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setGameSpeed(float gameSpeed);" >
                                            {
                                                `function onServerInitialise() {   
    server.setGameSpeed(0.7); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getGameSpeed();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server game speed: "+server.getGameSpeed() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setWaterLevel(float level);" >
                                            {
                                                `function onServerInitialise() {   
    server.setWaterLevel(0.9); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getWaterLevel();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server water level: "+server.getWaterLevel() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setAltitudeLimit(float altitudeLimit);" >
                                            {
                                                `function onServerInitialise() {   
    server.setAltitudeLimit(126.2); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getAltitudeLimit();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server altitude limit: "+server.getAltitudeLimit() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setKillCommandDelay(integer delayMillis);" >
                                            {
                                                `function onServerInitialise() {   
    server.setKillCommandDelay(3000); /*3 seconds*/
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getKillCommandDelay();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server /kill cmd delay: "+server.getKillCommandDelay() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setVehiclesForcedRespawnAltitude(float height);" >
                                            {
                                                `function onServerInitialise() {   
    server.setVehiclesForcedRespawnAltitude(15.8); 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getVehiclesForcedRespawnAltitude();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Vehicle respawn altitude: "+server.getVehiclesForcedRespawnAltitude() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setFallTimer(integer ms);" >
                                            {
                                                `function onServerInitialise() {   
    server.setFallTimer(1000); /* 1 second*/ 
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getFallTimer();" >
                                            {
                                                `function onServerInitialise() {   
    console.log( "Server fall timer: "+server.getFallTimer() );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setSpawnScreenPlayerPos(Vector pos);" >
                                            {
                                                `function onServerInitialise() {   
    server.setSpawnScreenPlayerPos(new Vector(140,23,200));
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setSpawnScreenCameraPos(Vector pos);" >
                                            {
                                                `function onServerInitialise() {
    server.setSpawnScreenCameraPos(new Vector(140,23,200));
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setSpawnScreenCameraLookAt(Vector pos);" >
                                            {
                                                `function onServerInitialise() {
    server.setSpawnScreenCameraLookAt(new Vector(140,23,200));
                                    ...
                                    <li>
                                        <PrismHighlight className="code-highlight serverSetOptions" language="javascript" title="Server options" >
                                            {
...
ServerOption.DisableHeliBladeDamage`
                                    ...
                                    <li>
                                        <PrismHighlight className="code-highlight serverSetOption" language="javascript" title="server.setOption(ServerOption setting, boolean value);" >
                                            {
                                                `function onServerInitialise() {
    ...
    server.setOption(ServerOption.DisableDriveby, true);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getOption(ServerOption setting);" >
                                            {
                                                `function onServerInitialise() {
    ...
    console.log( "Friendly fire is "+ (ffOn ? "on":"off") );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.setWastedSettings(WastedSettings settings);" >
                                            {
                                                `function onServerInitialise() {
    ...
    server.setWastedSettings(ws);
                            ...
                            <ul>
                            <li>
                                        <PrismHighlight language="javascript" title="server.getPlayer(integer id);" >
                                            {
`function onPlayerCommand(player, message) {
    if (message.startsWith("kick ")){
        ...
        if (p != null){
           server.kick(p);
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.findPlayer(String nickname);" >
                                            {
 `function onPlayerCommand(player, message) {
       if (message.startsWith("ping ")){
           ...
           if (p != null){
                server.sendClientMsg(player, new Colour(102, 162, 232), p.name + "'s ping:"+p.ping );
                                    ...
                                    <li>
                                        <PrismHighlight language="javascript" title="server.getAllPlayers();" >
                                            {
 `function onPlayerCommand(player, message) {
       if (message.startsWith("removeWeps")){
          server.getAllPlayers().forEach(p => {
             p.removeAllWeapons();
                            ...
                            <ul>
                                <li>
                                    <PrismHighlight language="javascript" title="server.getVehicle(integer id);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("veh ")){
        ...
        if (p != null){
            player.putInVehicle(v, 0, true, false);
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.createVehicle(integer modelId, integer worldId, Vector position, float angle, VehicleColours colours);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("heli ")){
         server.createVehicle(218, player.world, player.pos, 2.1, new VehicleColours(1, 1));
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.resetAllVehicleHandlings();" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("resetHandlings ")){
        server.resetAllVehicleHandlings()
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="Handling rules" >
                                            {
 ` HandlingRule.None
 HandlingRule.Mass
 ...
 HandlingRule.DriveOnWater`
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.resetHandling(integer modelId);" >
                                            {
 `server.resetHandling(181);`
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.resetHandlingRule(integer modelId, HandlingRule rule);" >
                                            {
 `server.resetHandlingRule(181, HandlingRule.MaxSpeed)`
                                ...
                                <li>
                                    <PrismHighlight description="returns float" language="javascript" title="server.getHandlingRule(integer modelId, HandlingRule rule);" >
                                            {
 `server.getHandlingRule(181, HandlingRule.MaxSpeed)`
                                ...
                                <li>
                                    <PrismHighlight  language="javascript" title="server.setHandlingRule(integer modelId, HandlingRule rule, float value);" >
                                            {
 `server.setHandlingRule(181, HandlingRule.MaxSpeed, 120.3)`
                                ...
                                <li>
                                    <PrismHighlight description="returns boolean" language="javascript" title="server.handlingRuleExists(integer modelId, HandlingRule rule);" >
                                            {
 `server.handlingRuleExists(181, HandlingRule.MaxSpeed)`
                                ...
                                <li>
                                    <PrismHighlight  language="javascript" title="server.addRadioStream(integer radioId, String name, String url, boolean isListed);" >
                                            {
 `server.addRadioStream(2,"radioStream", "http://....", true)`
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.removeRadioStream(integer modelId);" >
                                            {
 `server.removeRadioStream(2)`
                                ...
                                <li>
                                        <PrismHighlight language="javascript" title="server.getAllVehicles();" >
                                            {
 `function onPlayerCommand(player, message) {
       if (message.startsWith("deleteVehs ")){
          server.getAllVehicles().forEach(v => {
             v.delete();
                            ...
                            <ul>
                            <li>
                                    <PrismHighlight  language="javascript" title="server.createObject(integer modelId, integer worldId, Vector position, integer alpha);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("obj ")){
        ...
        server.createObject(id, player.world, player.pos, 255); 
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.getObject(integer id);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("delObj ")){
        ...
        if (obj !=null) {
            obj.delete();
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.showAllMapObjects();" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("showObjs ")){
        server.showAllMapObjects();
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.showMapObject(integer modelId, Vector position);" >
                                            {
 `function onPlayerCommand(player, message) { /* /showObject <modelID> <x> <y> <z>  */
    if (message.startsWith("showObject ")){
        ...
        server.showMapObject(modelID, new Vector(x, y , z) );
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.hideMapObject(integer modelId, Vector position);" >
                                            {
 `function onPlayerCommand(player, message) { /* /hideObject <modelID> <x> <y> <z>  */
    if (message.startsWith("hideObject ")){
        ...
        server.hideMapObject(modelID, new Vector(x, y , z) );
                            ...
                            <ul>
                            <li>
                                    <PrismHighlight  language="javascript" title="server.createPickup(integer modelId, integer worldId, integer quantity, Vector position, integer alpha, boolean automatic);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("pickup ")){
        ...
        server.createPickup(id, player.world, 1, player.pos, 255, true); 
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.getPickup(integer id);" >
                                            {
 `function onPlayerCommand(player, message) {
 ...
 `function onPlayerCommand(player, message) {
    if (message.startsWith("cp")){
        server.createCheckPoint(player, player.world, true, player.pos, new Colour(102, 162, 232), 1.3);
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.getCheckPoint(integer id);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("delCp ")){
        ...
        if (cp !=null) {
            cp.delete();
                            ...
                            <ul>
                            <li>
                                    <PrismHighlight  language="javascript" title="server.createCoordBlip(CoordBlipInfo blip);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("blip ")){
        ...
        server.createCoordBlip(blip);
                                ...
                                <li>
                                    <PrismHighlight language="javascript" title="server.destroyCoordBlip(integer id);" >
                                            {
 `function onPlayerCommand(player, message) {
    if (message.startsWith("delBlip ")){
        ...
        server.destroyCoordBlip(id);
                                ...
                                <li>
                                    <PrismHighlight  language="javascript" title="server.getCoordBlipInfo(integer id);" >
                                            {
 `function onPlayerCommand(player, message) {
        ...
        if (blip != null) { 
            blip.pos = player.pos;
                            ...
                            <ul>
                                ...
                                <li>
                                    <PrismHighlight  language="javascript" title="server.registerKeyBind(integer keyBindId, boolean onRelease, integer keyOne, integer keyTwo, integer keyThree);" >
                                            {
 `function onServerInitialise() {
    server.registerKeyBind(1, false, 0x12, 0, 0);
                            ...
                            <li>
                                    <PrismHighlight  language="javascript" title="server.removeKeyBind(integer keyBindId)" >
                                    {
 `function onServerInitialise() {
    server.removeKeyBind(0x12);
                            ...
                            <li>
                                    <PrismHighlight  language="javascript" title="server.removeAllKeyBinds();" >
                                            {
 `server.removeAllKeyBinds();`
                            ...
                            <li>
                                    <PrismHighlight description="returns int"  language="javascript" title="server.getUnusedKeybindSlot();" >
                                            {
 `var slot = server.getUnusedKeybindSlot();`
                            ...
                            <li>
                                    <PrismHighlight description="returns KeyBind"  language="javascript" title="server.getKeyBind(integer keyBindId)" >
                                            {
